...
public class RecommentFragement extends BaseFragment {
    private com.shitou.googleplay.lib.randomlayout.StellarMap stellarMap;
...
////        setContentView(R.layout.activity_main);
    ...
    protected View initView(ViewGroup container, LayoutInflater inflater){
        ...
        stellarMap = new com.shitou.googleplay.lib.randomlayout.StellarMap(getContext().getApplicationContext());
...
//        fl.addView(stellarMap);
    ...
    class StellarMapAdapter implements com.shitou.googleplay.lib.randomlayout.StellarMap.Adapter {
        /**
         * 返回多少组数据
         */
        @Override
